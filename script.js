...
document.getElementById('templateSelect').addEventListener('change', (event) => {
    ...
    switch(templateType) {
        case 'wa':
            targetUrlInput.value = 'https://chat.whatsapp.com/Ganti_Dengan_Kode_Grupmu';
            break;
        case 'tg':
            targetUrlInput.value = 'https://t.me/Ganti_Dengan_Nama_Grup_atau_Channel';
            break;
        case 'sp':
            targetUrlInput.value = 'https://shopee.co.id/Ganti_Dengan_Nama_Produk_atau_Toko';
            break;
        default:
